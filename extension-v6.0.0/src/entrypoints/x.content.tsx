...
const TWEET_COMPOSER_SELECTOR =
  ".css-175oi2r.r-kemksi.r-jumn1c.r-xd6kpl.r-gtdqiz.r-ipm5af.r-184en5c, .css-175oi2r.r-14lw9ot.r-jumn1c.r-xd6kpl.r-gtdqiz.r-ipm5af.r-184en5c, .css-175oi2r.r-yfoy6g.r-jumn1c.r-xd6kpl.r-gtdqiz.r-ipm5af.r-184en5c";
  ...
  async main(ctx) {
    ...
    ctx.addEventListener(window, "wxt:locationchange", async ({ newUrl }) => {
      ...
      if (statusPattern.includes(newUrl) || dialogPattern.includes(newUrl)) {
        ...
        if (targetElement?.querySelector(COMPONENT_NAME)) return;
      ...
      if (homePattern.includes(newUrl)) {
        ...
        if (targetElement?.querySelector(COMPONENT_HOME_NAME)) return;
