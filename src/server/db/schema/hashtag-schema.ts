...
export const hashtagPerformance = pgTable("hashtag_performance", {
  ...
  clickThroughRate: decimal("click_through_rate", {
    precision: 5,
    scale: 2,
  }).default("0.00"),
  ...
  // Trend data
  trendScore: decimal("trend_score", { precision: 5, scale: 2 }).default(
    "0.00",
  ),
...
export const hashtagTrends = pgTable("hashtag_trends", {
  ...
  growthRate: decimal("growth_rate", { precision: 5, scale: 2 }).default(
    "0.00",
  ),
...
export const hashtagOptimization = pgTable("hashtag_optimization", {
  ...
  minEngagementRate: decimal("min_engagement_rate", {
    precision: 5,
    scale: 2,
  }).default("2.00"),
...
export const hashtagSets = pgTable("hashtag_sets", {
  ...
  avgClickThroughRate: decimal("avg_click_through_rate", {
    precision: 5,
    scale: 2,
  }).default("0.00"),
...
export const hashtagCompetition = pgTable("hashtag_competition", {
  ...
  avgEngagement: decimal("avg_engagement", { precision: 10, scale: 2 }).default(
    "0.00",
  ),
  topPostEngagement: decimal("top_post_engagement", {
    precision: 10,
    scale: 2,
  }).default("0.00"),

  // Competition analysis
  competitionScore: decimal("competition_score", {
    precision: 5,
    scale: 2,
  }).default("0.00"), // 0-100
  difficulty: text("difficulty"), // easy, medium, hard, very_hard
  opportunity: decimal("opportunity", { precision: 5, scale: 2 }).default(
    "0.00",
  ), // 0-100
...
// Relations
export const hashtagPerformanceRelations = relations(
  hashtagPerformance,
  ({ one }) => ({
...
export const hashtagCompetitionRelations = relations(
  hashtagCompetition,
  () => ({
    // Add relations if needed
  }),
