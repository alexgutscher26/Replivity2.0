    ...
    <div className="fixed bottom-4 right-4 bg-blue-600 text-white p-4 rounded-lg shadow-lg z-50">
      <div className="flex items-center space-x-3">
        <div className="flex-1">
          ...
          <p className="text-sm opacity-90">Click to update and reload the app.</p>
        </div>
...
export const cacheUtils = {
  ...
  async getCacheSize() {
    if (typeof window !== 'undefined' && 'caches' in window && 'storage' in navigator && 'estimate' in navigator.storage) {
