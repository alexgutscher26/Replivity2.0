...
import { Shield, AlertTriangle, Users, Activity, Search, Clock } from "lucide-react";
...
function getEventTypeColor(eventType: string) {
  switch (eventType) {
    ...
    case 'password_breach': return 'bg-red-100 text-red-800';
    case 'multiple_failed_attempts': return 'bg-orange-100 text-orange-800';
    case 'account_compromise': return 'bg-red-100 text-red-800';
    case 'admin_forced': return 'bg-purple-100 text-purple-800';
    case 'password_expired': return 'bg-amber-100 text-amber-800';
    case 'two_factor_disabled': return 'bg-orange-100 text-orange-800';
    case 'session_hijack': return 'bg-red-100 text-red-800';
    default: return 'bg-gray-100 text-gray-800';
  }
}
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage security events, force password resets, and monitor user security status.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Users requiring password reset</p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="actions" className="space-y-4">
        ...
        <TabsContent value="actions" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Dialog open={isForceResetDialogOpen} onOpenChange={setIsForceResetDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    This will require the user to reset their password before they can access the application.
                  </DialogDescription>
                </DialogHeader>
                <Form {...forceResetForm}>
                  <form onSubmit={forceResetForm.handleSubmit(onForceReset)} className="space-y-4">
                    <FormField
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea {...field} placeholder="Explain why the password reset is required" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    >
                      {forcePasswordResetMutation.isPending ? "Processing..." : "Force Reset"}
                    </Button>
                  </form>
                </Form>
              </DialogContent>
            ...
            <Dialog open={isLogEventDialogOpen} onOpenChange={setIsLogEventDialogOpen}>
              <DialogTrigger asChild>
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardHeader>
              ...
              <DialogContent className="max-w-2xl">
                ...
                <Form {...logEventForm}>
                  <form onSubmit={logEventForm.handleSubmit(onLogEvent)} className="space-y-4">
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="password_breach">Password Breach</SelectItem>
                                ...
                                <SelectItem value="password_expired">Password Expired</SelectItem>
                                <SelectItem value="two_factor_disabled">Two Factor Disabled</SelectItem>
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} value={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="two_factor_required">Two Factor Required</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea {...field} placeholder="Describe the security event" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="Browser/device info" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    >
                      {logSecurityEventMutation.isPending ? "Logging..." : "Log Event"}
                    </Button>
                  </form>
                </Form>
              </DialogContent>
            ...
            <Dialog open={isSetExpiryDialogOpen} onOpenChange={setIsSetExpiryDialogOpen}>
              <DialogTrigger asChild>
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardHeader>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configure when the user&apos;s password should expire and require reset.
                  </DialogDescription>
                </DialogHeader>
                <Form {...setExpiryForm}>
                  <form onSubmit={setExpiryForm.handleSubmit(onSetExpiry)} className="space-y-4">
                    <FormField
                    ...
                    >
                      {setPasswordExpiryMutation.isPending ? "Setting..." : "Set Expiry"}
                    </Button>
                  </form>
                </Form>
              </DialogContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex space-x-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button onClick={() => void refetchUserEvents()} disabled={!selectedUserId}>
                  Search
                </Button>
              </div>
              ...
              {selectedUserId && userEvents && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold">Events for User: {selectedUserId}</h3>
