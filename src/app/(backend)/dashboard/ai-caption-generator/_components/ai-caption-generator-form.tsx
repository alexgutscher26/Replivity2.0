...
export function AiCaptionGeneratorForm() {
  ...
  const onSubmit = async (data: CaptionGeneratorFormValues) => {
    ...
    if (accountSettings && !accountSettings.customPrompt) {
      ...
      if (
        accountSettings.brandTone &&
        accountSettings.brandTone !== "professional"
      ) {
        if (
          accountSettings.brandTone === "custom" &&
          accountSettings.customTone
        ) {
    ...
    const contextText = data.context
      ...
      : "";
    const hashtagText = data.hashtags
      ? " Include relevant hashtags."
      : " Do not include hashtags.";
    const mentionText = data.mentions
      ? " Include relevant mentions if appropriate."
                            ...
                            <ul className="ml-2 list-inside list-disc space-y-0.5">
                              ...
                              {selectedPlatform.rules.length > 3 && (
                                <li className="text-muted-foreground/70">
                                  + {selectedPlatform.rules.length - 3} more
                                  guidelines
                                </li>
                              )}
                            </ul>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Help the AI understand what you want to emphasize in the
                      caption.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
        ...
        <CardContent>
          {generatedCaptions.length > 0 ? (
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {generatedCaptions.map((_, index) => (
                    <Button
                      key={index}
                      variant={
                        selectedCaptionIndex === index ? "default" : "outline"
                      }
                      size="sm"
              ...
              <div className="bg-muted rounded-lg p-4">
                <p className="whitespace-pre-wrap">
                  {generatedCaptions[selectedCaptionIndex]}
                </p>
              </div>
            ...
            <div className="text-muted-foreground py-12 text-center">
              ...
              <p>
                Upload an image and click "Generate Caption" to get started.
              </p>
            </div>
          )}
        </CardContent>
