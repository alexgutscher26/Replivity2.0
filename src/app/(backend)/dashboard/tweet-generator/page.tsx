...
export const metadata: Metadata = {
  ...
  description:
    "Generate authentic, human-like tweets that pass AI detection. Create engaging Twitter content with optional emojis and hashtags using advanced AI models.",
  keywords: [
    "tweet generator",
  ...
  openGraph: {
    ...
    description:
      "Generate authentic, human-like tweets that pass AI detection. Create engaging Twitter content instantly.",
    type: "website",
...
const tweetGeneratorStructuredData = {
  ...
  description:
    "AI-powered tweet generator that creates human-like, authentic Twitter content with optional emojis and hashtags.",
  url: "https://replivity.com/dashboard/tweet-generator",
        ...
        <div className="flex-1 space-y-6 p-10 pb-16">
          <div className="space-y-0.5">
            ...
            <p className="text-muted-foreground">
              Generate authentic, human-like tweets that pass AI detection with
