...
export function ProfileAuditTool() {
  ...
  const [profileMetrics, setProfileMetrics] = useState<ProfileMetrics | null>(
    null,
  );
  ...
  const analyzeProfile = async (data: ProfileAuditFormValues) => {
    ...
    try {
          ...
          items: [
            {
              ...
              status: "complete",
              suggestion:
                "Great! You have a clear, professional profile picture.",
            },
            {
              name: "Bio Description",
              status: "needs_improvement",
              suggestion:
                "Add more keywords and a clear call-to-action to your bio.",
            },
            {
              name: "Contact Information",
              status: "incomplete",
              suggestion:
                "Add your email or website link for better accessibility.",
            },
            {
              name: "Link in Bio",
              status: "complete",
            ...
            },
            {
              ...
              suggestion:
                data.platform === "instagram"
                  ? "Create more story highlights to showcase your content categories."
              ...
              analysis: [
                ...
                },
                {
                  ...
                  opportunities: [
                    ...
                    "Poor bio optimization",
                    "Limited link strategy",
                  ],
                },
              ],
              insights: [
        ...
        actionPlan: [
          {
            ...
            action:
              "Update bio with clear value proposition and call-to-action",
      ...
      toast.success("Profile analysis completed!", {
        description:
          "Your comprehensive audit is ready with actionable insights.",
      });
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your profile details to get a comprehensive audit with
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Comprehensive includes detailed insights, competitive
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      ...
                      {platformConfig[selectedPlatform].name} profile.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                {analysis && (
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() =>
                        window.open(form.getValues("profileUrl"), "_blank")
                      }
                    >
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {profileMetrics.followers.toLocaleString()}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {profileMetrics.engagement.toFixed(1)}%
                    </div>
                    <div className="text-muted-foreground text-sm">
                      Engagement Rate
                    </div>
                  ...
                  <div className="text-center">
                    <div
                      className={`text-2xl font-bold ${
                        profileMetrics.growthRate > 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
                      {profileMetrics.growthRate > 0 ? "+" : ""}
                      {profileMetrics.growthRate.toFixed(1)}%
                    </div>
                    <div className="text-muted-foreground text-sm">
                      Growth Rate
                    </div>
                ...
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={getScoreBadgeVariant(
                      analysis.profileCompleteness.score,
                    )}
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-1">
                      {analysis.contentQuality.strengths.map(
                        (strength, index) => (
                          <li
                            key={index}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {analysis.contentQuality.weaknesses.map(
                        (weakness, index) => (
                          <li
                            key={index}
                            className="text-muted-foreground flex items-center gap-2 text-sm"
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={getScoreBadgeVariant(analysis.engagement.score)}
                  >
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-2xl font-bold">
                        {analysis.engagement.rate.toFixed(1)}%
                      </div>
                      <div className="text-muted-foreground text-sm">
                        Your Rate
                      </div>
                  ...
                  <div className="flex items-center gap-2">
                    <TrendingUp
                      className={`h-4 w-4 ${
                        analysis.engagement.trend === "up"
                          ? "text-green-600"
                          : analysis.engagement.trend === "down"
                            ? "text-red-600"
                            : "text-yellow-600"
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {analysis.engagement.suggestions.map(
                        (suggestion, index) => (
                          <li
                            key={index}
                            className="text-muted-foreground flex items-center gap-2 text-sm"
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">
                      {analysis.posting.frequency}
                    </div>
                  </div>

                  <div>
                    <div className="mb-2 font-medium">Consistency Score</div>
                    <Progress
                      value={analysis.posting.consistency}
                      className="h-2"
                    />
                    <div className="text-muted-foreground mt-1 text-sm">
                      {analysis.posting.consistency}%
                    </div>
                  </div>

                  <div>
                    <div className="mb-2 font-medium">Best Posting Times</div>
                    <div className="flex gap-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {analysis.hashtags.usage}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Effectiveness</span>
                      <span className="font-medium">
                        {analysis.hashtags.effectiveness}%
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="mb-3 font-medium">Top Performing Hashtags</h4>
              ...
              <div>
                <h4 className="mb-2 font-medium">Optimization Tips</h4>
                <ul className="space-y-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div>
                  <h4 className="mb-3 font-medium">Age Distribution</h4>
                  <div className="space-y-2">
                    {analysis.audience.demographics.ageGroups.map(
                      (group, index) => (
                        <div
                          key={index}
                ...
                <div>
                  <h4 className="mb-3 font-medium">Gender Split</h4>
                  <div className="space-y-2">
                    {analysis.audience.demographics.genders.map(
                      (gender, index) => (
                        <div
                          key={index}
                          className="flex items-center justify-between"
                ...
                <div>
                  <h4 className="mb-3 font-medium">Top Locations</h4>
                  <div className="space-y-2">
                    {analysis.audience.demographics.locations.map(
                      (location, index) => (
                        <div
                          key={index}
                          className="flex items-center justify-between"
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  {analysis.competitors.analysis.map((competitor, index) => (
                    <div key={index} className="rounded-lg border p-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                          <h5 className="mb-2 font-medium text-green-600">
                            Their Strengths
                          </h5>
                          <ul className="space-y-1">
                        ...
                        <div>
                          <h5 className="mb-2 font-medium text-blue-600">
                  ...
                  <div>
                    <h4 className="mb-2 font-medium">Competitive Insights</h4>
                    <ul className="space-y-1">
              ...
              <div className="space-y-4">
                {analysis.actionPlan.map((action, index) => (
                  <div key={index} className="rounded-lg border p-4">
                    ...
                    <h4 className="mb-1 font-medium">{action.action}</h4>
