...
import {
  ...
  replierUsage,
  replierTwoFactor,
  replierSecurityEvent,
  replierBlogPost,
  replierBlogComment,
  replierBlogPostCategory,
  replierBlogCategory,
  replierBlogPostTag,
  replierBlogTag,
  replierBlogCommentLike,
} from "./schema";
...
export const replierProductsRelations = relations(
  replierProducts,
  ({ many }) => ({
    replierBillings: many(replierBilling),
    replierGenerations: many(replierGeneration),
...
export const replierGenerationRelations = relations(
  replierGeneration,
  ({ one }) => ({
    replierUser: one(replierUser, {
...
export const replierTwoFactorRelations = relations(
  replierTwoFactor,
  ({ one }) => ({
    replierUser: one(replierUser, {
...
export const replierSecurityEventRelations = relations(
  replierSecurityEvent,
  ({ one }) => ({
    replierUser: one(replierUser, {
...
export const replierBlogPostRelations = relations(
  replierBlogPost,
  ({ one, many }) => ({
    replierUser: one(replierUser, {
...
export const replierBlogCommentRelations = relations(
  replierBlogComment,
  ({ one, many }) => ({
...
export const replierBlogPostCategoryRelations = relations(
  replierBlogPostCategory,
  ({ one }) => ({
    replierBlogPost: one(replierBlogPost, {
...
export const replierBlogCategoryRelations = relations(
  replierBlogCategory,
  ({ many }) => ({
    replierBlogPostCategories: many(replierBlogPostCategory),
  }),
...
export const replierBlogPostTagRelations = relations(
  replierBlogPostTag,
  ({ one }) => ({
    replierBlogPost: one(replierBlogPost, {
...
export const replierBlogTagRelations = relations(
  replierBlogTag,
  ({ many }) => ({
    replierBlogPostTags: many(replierBlogPostTag),
  }),
...
export const replierBlogCommentLikeRelations = relations(
  replierBlogCommentLike,
  ({ one }) => ({
    replierBlogComment: one(replierBlogComment, {
