-- Drop existing hashtag tables to recreate with correct types
...
DROP TABLE IF EXISTS "hashtag_competition" CASCADE;
DROP TABLE IF EXISTS "hashtag_optimization" CASCADE;
DROP TABLE IF EXISTS "hashtag_templates" CASCADE;
